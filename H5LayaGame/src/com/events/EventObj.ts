...
export class EventObj {
    ...
    public static create( type: string, listener: Function, target: Laya.EventDispatcher = null, thisObj: any = null ):EventObj{
    ...
    private _target: Laya.EventDispatcher;
     ...
     * 
     */
    public constructor( type: string = "" , listener: Function = null , target: Laya.EventDispatcher = null, thisObj: any = null ) {
    ...
    public set target( value:Laya.EventDispatcher ){

        this._target = value;
    }

    public get target(): Laya.EventDispatcher {
