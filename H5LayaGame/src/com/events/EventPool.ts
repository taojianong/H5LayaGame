...
class EventPool {
	 ...
	 * @param thisObj
	 */
	public addListener( type:string , listener:Function , target:Laya.EventDispatcher = null , thisObj:any ):void{
	 ...
	 * @param thisObj	
	 */
	public removeListener( type:string , listener:Function , target:Laya.EventDispatcher = null , thisObj:any ):void{
	 ...
	 * @param thisObj	
	 */
	public hasEventListener( type:string , listener:Function , target:Laya.EventDispatcher = null , thisObj:any ):boolean{
