...
export class EGList extends BaseSprite {
	...
	protected _itemRenderer: Laya.Handler = null;
	...
	* 上一页
	*/
	private touchLeftBtnHandler(e: Laya.Event): void {
	 ...
	 * 下一页
	 */
	private touchRightBtnHandler(e: Laya.Event): void {
	...
	public set itemProvider(value: Laya.Handler) {
	...
	public set itemRenderer(value: Laya.Handler) {
	...
	/**渲染方法 */
	public get itemRenderer():Laya.Handler {
	...
	public get selectionMode():number  {//fairygui.ListSelectionMode
		return this.list.selectionMode;
	}
	/**选择模式 */
	public set selectionMode(value: number) {//fairygui.ListSelectionMode
	...
	/**
	  * 点击条目
	  */
	protected clickItem(e: any): void {//fairygui.ItemEvent
	...
	public set selectedIndex(value: number) {
		...
		if (this.isSingleSelect) {
			...
			if (item instanceof UIEListRenderItem || item instanceof BaseButton ) {
	...
	public set layout(value:number ) {//fairygui.ListLayoutType

		this.list.layout = value;
	}

	public set align(value:string ) {//fairygui.AlignType

		this.list.align = value;
	}
	/**左右布局 */
	public get align(): string {//fairygui.AlignType
	...
	public localToGlobal(ax?: number, ay?: number, resultPoint?: Laya.Point): Laya.Point {
